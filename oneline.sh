...
# 16 hex dari /dev/urandom = 2^64 kemungkinan (jauh lebih banyak dari 1jt kata),
# nggak perlu bawa wordlist. Di-bake sekali pas config pertama dibuat -> stabil per server.
RANDPASS=""
